    		...
    		<table class="table table-bordered text-center">
    			...
    			<tbody>
    				...
    				<tr>
    					...
    					<td>
    						<a href="{{route('items.show',$item->id)}}" class="btn btn-outline-primary"><i class="fa fa-info-circle" aria-hidden="true"></i></a>
    						<a href="{{route('items.edit',$item->id)}}" class="btn btn-outline-success"><i class="fas fa-edit"></i></a>
                           ...
                           <form action="{{route('items.destroy',$item->id)}}" method="POST" class="d-inline-block">
                                ...
                                <button class="btn btn-outline-warning "><i class="fa fa-trash" aria-hidden="true"></i></i></button>
                            </form>
    					</td>
    				</tr>
    				@endforeach
